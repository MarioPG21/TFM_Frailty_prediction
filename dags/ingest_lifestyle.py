"""
DAG de ingesta de encuestas de estilo de vida (Fuente B2).
...
@dag(
    dag_id="ingest_lifestyle",
    schedule=SCHEDULE_INGEST,
    start_date=datetime(2024, 1, 1),
    catchup=False,
    max_active_runs=1,
    tags=["ingestion", "lifestyle"],
)
def ingest_lifestyle_dag():

    @task
    def run_bronze():
        _run("bronze_lifestyle")

    run_silver = BashOperator(
        task_id="run_silver",
        bash_command=_SUBMIT + " silver_lifestyle",
