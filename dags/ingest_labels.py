"""
DAG de ingesta de etiquetas de fragilidad (Fuente D / labels).
...
@dag(
    dag_id="ingest_labels",
    schedule=SCHEDULE_INGEST,
    start_date=datetime(2024, 1, 1),
    catchup=False,
    max_active_runs=1,
    tags=["ingestion", "labels"],
)
def ingest_labels_dag():
    ...
    run_silver = BashOperator(
        task_id="run_silver",
        bash_command=_SUBMIT + " silver_labels",
